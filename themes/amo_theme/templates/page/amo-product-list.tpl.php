<div class="product-list">
  ...
  <?php
    $filter_links = array();
    $type_chateau = array(
      'castle' => 'Chateau les amoureuses',
      'land' => 'Terres des amoureuses'
    );
    foreach ($type_chateau as $tid => $name) {
      $filter_links[$tid] = array(
        'vocabulary' => 'type_chateau',
        'term_name' => $name
      );
    }
    $vocabs = array(/*'type_chateau',*/
      'color'
    );
  ...
  <div class="R mobile-title mobile-only">
    ...
    <div id="product-filter-boutique-2" class="filter-block" style="width: 100%; margin-left: 2rem; position: absolute; bottom: -3rem;">
      <a href="#" class="toggle-filter" style="color: #fff;"><?php echo t('FILTER PAR'); ?></a>

      <div class="filter-select hidden" style="display: none; position: absolute;">
  ...
  <div class="product-list-wrapper">
    <div class="wrapper scroll-mobile-to">
      <div class="product-list-content"><?php print render($products); ?></div>
    </div>
  </div>
